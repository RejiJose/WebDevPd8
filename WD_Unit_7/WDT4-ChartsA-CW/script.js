...
function chart(type){
  //Task 2: Combine the math, english, science and social data into one array and store in a variable 'data'
  data = [math, english, science, social];
  
  //Task 3: Using the "type" of chart passed, create an appropriate chart of that "type" in the "chart" container using the data from Task 2
  displayChart(data, "chart", type);
}

//Task 4: Create a budget that includes at least 6 items. Recall that the data has to be structured as an array of arrays.
let budget =[
  ["Rent",1500],
  ["Food",600],
  ["Car",500],
...
function budgetChart(){
  //Task 5: Display the budget as a pie chart
