function createStory(){
  //Following are variables for each of the <span>s that are located throughout the story
  ...
  */
  ...
  /* Task 4: Set the innerHTML for each of the spans on lines 3 to 9 with the appropriate values from the variables you created in Task 3. */
